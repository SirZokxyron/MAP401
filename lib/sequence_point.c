...
/* Fonctions pour gerer les structures de donnees */
	...
	/* creer une cellule de liste avec l'element v renvoie le pointeur sur la cellule de liste creee la fonction s'arrete si la creation n'a pas pu se faire */
	...
	/* creer une sequence de points sous forme d'un tableau de points a partir de la liste de points L */
	...
	/* ecrire le contour L a l'ecran cette fonction montre un exemple de conversion d'une liste de points en tableau de points afin de pouvoir par la suite acceder aux elements d'une sequence de points par indice */
